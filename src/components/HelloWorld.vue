      ...
      <div class="container">
        <div class="col-md-6 top-header-agile-left">
          <ul>
            ...
            <li><a href="mailto:info@example.com">783941739@qq.com</a></li>
          </ul>
        </div>
          ...
          <ul class="rslides" id="slider4">
            <li>
              <div class="banner-info">
                <h3>To Travel</h3>
                <p>IS TO LIVE</p>
                <div class="arrows"><img src="static/images/border.png" alt="border"/></div>
        ...
        <div class="gallery-grids">
          ...
          <div class="col-md-3 baner-top ban-mar">
            <a href="images/g5.jpg" class="b-link-stripe b-animate-go  swipebox">
              <div class="gal-spin-effect vertical ">
                <img src="static/images/g5.jpg" alt=" " />
                <div class="gal-text-box">
                  <div class="info-gal-con">
                    <h4>View</h4>
                  </div>
          ...
          <div class="col-md-3 baner-top ban-mar">
            <a href="images/g6.jpg" class="b-link-stripe b-animate-go  swipebox">
              <div class="gal-spin-effect vertical ">
                <img src="static/images/g6.jpg" alt=" " />
                <div class="gal-text-box">
                  <div class="info-gal-con">
                    <h4>View</h4>
                  </div>
      ...
      <div class="container">
        ...
        <div class="news-content-w3layouts">
          <div class="col-md-6 col-sm-6 newsl">
            ...
            <a href="#" data-toggle="modal" data-target="#myModal"><img src="static/images/news.jpg" alt="" /></a>
          ...
          <div class="col-md-6 col-sm-6 newsr">
            ...
            <div class="newsrt">
              <div class="col-md-3 col-sm-3 newsrtl">
                <a href="#" data-toggle="modal" data-target="#myModal"><img src="static/images/b1.jpg" alt=" " /></a>
              </div>
            ...
            <div class="newsrt">
              <div class="col-md-3 col-sm-3 newsrbl">
                <a href="#" data-toggle="modal" data-target="#myModal"><img src="static/images/b2.jpg" alt=" " /></a>
              </div>
          ...
          <div class="team-bottom">
            <div class="col-md-3 team-grids tg1">
              <div class="ih-item circle effect5">
                <a href="#">
                  <div class="img"><img src="static/images/t1.jpg" alt="img" class="img-responsive"></div>
                  <div class="info">
                    <div class="info-back">
                      <h3>Kristen</h3>
                    </div>
            ...
            <div class="col-md-3 team-grids tg2">
              <div class="ih-item circle effect5">
                <a href="#">
                  <div class="img"><img src="static/images/t2.jpg" alt="img" class="img-responsive"></div>
                  <div class="info">
                    <div class="info-back">
                      <h3>Lisa</h3>
                    </div>
            ...
            <div class="col-md-3 team-grids tg3">
              <div class="ih-item circle effect5">
                <a href="#">
                  <div class="img"><img src="static/images/t3.jpg" alt="img" class="img-responsive"></div>
                  <div class="info">
                    <div class="info-back">
                      <h3>Johnson</h3>
                    </div>
            ...
            <div class="col-md-3 team-grids">
              <div class="ih-item circle effect5">
                <a href="#">
                  <div class="img"><img src="static/images/t4.jpg" alt="img" class="img-responsive"></div>
                  <div class="info">
                    <div class="info-back">
                      <h3>Martina</h3>
                    </div>
  ...
  mounted: function () {
    ...
    this.$axios
      ...
      .then(successResponse => {
        _this.userInfo = successResponse.data.data
